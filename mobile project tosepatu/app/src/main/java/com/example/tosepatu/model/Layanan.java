...
public class Layanan {
    ...
    public Layanan(int id, String idLayanan, int WaktuPengerjaan,String NamaLayanan, int hargaLayanan, String fotoLayanan, String description, int userId, String createdAt, String updatedAt) {
        this.id = id;
